...
const NavItem: FC<NavItemProps> = ({icon,label,link}) => {
  ...
  return <div>
    <Link href={link} className="relative group xl:flex items-center justify-center gap-3 cursor-pointer hover:bg-[rgba(255,255,255,.2)] rounded-full p-3 duration-200 xl:rounded-full">
        {icon}
