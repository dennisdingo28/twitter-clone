...
const SearchUserInput = () => {
  ...
  return (
    <div className="relative z-10" ref={containerRef}>
      ...
      <SearchUserResults
        data={data}
        className={`absolute left-0 -bottom-[2.9rem] w-full rounded-md bg-black shadow-[0px_0px_5px_rgba(255,255,255,.5)] ${(data && data.length > 0) ? "h-[220px] -bottom-[220px] overflow-y-scroll contentScroll" : ""
